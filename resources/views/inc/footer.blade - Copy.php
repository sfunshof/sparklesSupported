            ...
            <div class="col-lg-4 col-md-7">
                <div class="footer-widget pl-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="footer-widget">
                                <ul class="footer-list">
                                    <li>
                                       <a href="{{ url('miscellaneous/covid19') }}" >
                                             Covid-19 Support
                                       </a>
                                    </li>
                                </ul>
                    ...
                    <ul class="social-link">
                        <li>
                            <a href="https://www.facebook.com/sparkles.healthcare" target="_blank"><i class='bx bxl-facebook'></i></a>
                        </li> 
                        <li>
                            <a href="https://twitter.com/intent/tweet?screen_name=TwitterDev&ref_src=twsrc%5Etfw" target="_blank"><i class='bx bxl-twitter'></i></a>
                        </li> 
                        <!--
                        <li>
